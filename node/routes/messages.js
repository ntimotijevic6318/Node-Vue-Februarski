...
route.post('/telefoni', (req, res) => {
    ...
    if (error)
        ...
        let query = "insert into telefoni (markaTelefona, modelTelefona , opisModela) values (?, ? , ?)";
        let formated = mysql.format(query, [req.body.markaTelefona, req.body.modelTelefona , req.body.opisModela]);
...
route.put('/telefon/:id', (req, res) => {
    ...
    if (error)
        ...
        let query = "update telefoni set markaTelefona=?, modelTelefona=? where id=?";
